        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment:
                    MainAxisAlignment.spaceBetween, // Space between for alignment
                children: [
                  Row(
                    children: [
                      const Text(
              ...
              const SizedBox(height: 20), // Spacing between search and confirm button
              ...
              Center(
                child: Column(
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: const EdgeInsets.symmetric(
                            horizontal: 100, vertical: 16), // Button size
                      ),
                      child: const Text(
                        'Confirm Location',
                        style: TextStyle(
                    ...
                    const SizedBox(height: 10), // Spacing between button and location text

                    // "Please enter your location" text on the left and "Map" on the right
                    Row(
